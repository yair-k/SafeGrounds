...
def manage_mining_locations():
    if request.method == 'POST':
        ...
        if location_id or location_name or location_coords:
            ...
            all_lands = MiningLocation.query.all()
            if not all_lands:
            ...
            result = [{
                ...
                "type_of_mining": land.type_of_mining,
                "tenure": land.tenure,
                "affect_radius": land.affect_radius,
                "impact_scale": land.impact_scale,
                "water_quality": land.water_quality,
                "air_quality": land.air_quality,
                "soil_quality": land.soil_quality,
                "biodiversity": land.biodiversity,
                "socioeconomic_index": land.socioeconomic_index,
                "description": land.description,
                "location_coords": land.location_coords,
                "assessment": land.assessment
...
def chatbot():
    ...
    # Generate GPT prompt based on user question and land ID
    gpt_prompt = f"Answer the following question about mining quality for land {land_name}: {user_question}"
